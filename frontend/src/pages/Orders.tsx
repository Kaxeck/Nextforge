...
function ActiveView({ onSelectDetail }: { onSelectDetail: () => void }) {
  // PROD-LEVEL IMPLEMENTATION NOTE: Active orders are tracked via real-time Soroban event listeners.
  // In this demo, we show simulated production runs with dynamic USDC streaming.
  return (
